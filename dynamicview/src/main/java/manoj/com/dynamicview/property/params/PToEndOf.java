 ...
 */
public class PToEndOf extends IDLayoutProperty {

    public PToEndOf(String data) {
        super(data);
    }
    ...
    protected void addRule(ViewGroup.LayoutParams params, HashMap<String, Integer> ids) {
        if (ids.containsKey(getValue())) {
            ((RelativeLayout.LayoutParams) params).addRule(RelativeLayout.END_OF, ids.get(getValue()));
        }
    }
}
