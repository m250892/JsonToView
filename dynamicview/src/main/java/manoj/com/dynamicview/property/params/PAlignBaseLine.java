 ...
 */
public class PAlignBaseLine extends IDLayoutProperty {

    public PAlignBaseLine(String data) {
        super(data);
    }
    ...
    protected void addRule(ViewGroup.LayoutParams params, HashMap<String, Integer> ids) {
        if (ids.containsKey(getValue())) {
            ((RelativeLayout.LayoutParams) params).addRule(RelativeLayout.ALIGN_BASELINE, ids.get(getValue()));
        }
    }
}
